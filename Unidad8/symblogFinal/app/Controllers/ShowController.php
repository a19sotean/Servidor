...
class ShowController extends BaseController {
    public function getShowBlog($request) {
        return $this->renderHTML('showBlog.twig', $this->getBlogs(self::getId($request)));
    }
    ...
    public function postComment($request) {
        ...
        return $this->renderHTML('showBlog.twig', array_merge($this->getBlogs(self::getId($request)), ["msg"=>$msg, "error"=>$error]));
    }
